...
use App\Domain\Download\DownloadedFile;
...
use App\Services\Vault\AtomicFileMover;
...
final readonly class DownloadExecutor
{
    public function __construct(
        ...
        private TempStagingService $tempStaging,
        private VaultPathBuilder $vaultPaths,
        private AtomicFileMover $fileMover,
