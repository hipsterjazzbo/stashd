...
use App\Infrastructure\Persistence\ActivityEventRepository;
...
final readonly class ActivityEventService
{
    ...
    public function stashCreatedFromPreflight(
        ...
        JobRecord $job,
        \App\Services\Stash\StashFromPreflightResult $result,
    ): ActivityEventRecord {
        $record = $this->events->create(
            level: ActivityLevel::Success,
    ...
    public function downloadCompleted(
        CommandRecord $command,
        JobRecord $job,
        \App\Services\Download\DownloadExecutionResult $result,
    ): ActivityEventRecord {
        $record = $this->events->create(
            level: ActivityLevel::Success,
