...
use App\Domain\Broadcast\BroadcastTriggerType;
...
use App\Infrastructure\Persistence\BroadcastTriggerRepository;
use App\Infrastructure\Persistence\BroadcastTriggerRunRepository;
use App\Infrastructure\Persistence\MediaServerConnectionRepository;
use App\Infrastructure\Persistence\RecordTimestamps;
use App\Services\MediaServer\MediaServerClientRegistry;
use App\Services\MediaServer\MediaServerConnectionService;
use App\Services\MediaServer\MediaServerTokenResolver;
...
final readonly class BroadcastTriggerService
{
    ...
    public function ensureScanTrigger(BroadcastRecord $broadcast): ?\App\Domain\Broadcast\BroadcastTriggerRecord
    {
    ...
    private function triggerTypeForBroadcast(BroadcastRecord $broadcast): ?BroadcastTriggerType
    {
        return match ($broadcast->type) {
            BroadcastType::JellyfinSeries => BroadcastTriggerType::JellyfinScan,
            BroadcastType::PlexSeries => BroadcastTriggerType::PlexScan,
            default => null,
        };
    }
    ...
    private function markTriggerFailed(\App\Domain\Broadcast\BroadcastTriggerRecord $trigger, string $error): void
    {
        $trigger->lastTriggeredAt = RecordTimestamps::now();
    ...
    private function transitionRun(
        \App\Domain\Broadcast\BroadcastTriggerRunRecord $run,
